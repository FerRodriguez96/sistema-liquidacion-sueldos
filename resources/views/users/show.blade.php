                ...
                <div class="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-lg">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $user->jobTitle->name }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $user->last_name }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-medium text-gray-900 dark:text-gray-100">${{ number_format($user->jobTitle->base_salary, 2) }}</p>
                        </div>
